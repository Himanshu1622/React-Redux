...
const ProductComponent = () => {
    ...
    const renderList = products.map((product) => {
        ...
        return (
            <div key={id} className="max-w-md bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
                <Link to={`products/${id}`} className="no-underline text-black">
